...
import 'package:flutter_application_final/UI/FavoriteWordScreen/favarite_word.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  ProfileWidget(
                    ...
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const FavoriteWord(),)),
                  ),
                  ProfileWidget(
                    icon: Icons.logout,
                    title: 'Đăng xuất',
