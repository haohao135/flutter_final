...
class TypingResult extends StatefulWidget {
  TypingResult({super.key, required this.topic, required this.correctAnswer, required this.results, required this.second});
    Topic topic;
  int second;
  int correctAnswer;
  List<String> results;
  @override
  State<TypingResult> createState() => _TypingResultState();
}

class _TypingResultState extends State<TypingResult> {
  int? phantram;
                  ...
                  return Column(
                    ...
                    children: [
                      widget.results[index].toLowerCase() ==
                              widget.topic.listWords[index].definition.toLowerCase()
                          ? Container(
